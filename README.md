...
|:----:|:----:|:----:|
|帳號 | string | 檢查帳號是否註冊過 |
|密碼 | string | 檢查是否為此帳號之密碼 |

## 註冊畫面
![fig](註冊.jpg "註冊畫面")
| 欄位名稱 | 資料型態 | 驗證規則 |
|:-------:|:-------:|:-------:|
|使用者名稱 | string | 16個字元內的英數組合|
|手機 | int | 10個字元的整數，開頭須為09 |
|電子信箱 | string | 檢查電子信箱是否符合規定 |
|密碼 | string | 可輸入英數符號組合，但不可有空格 |
|確認密碼 | string | 是否與密碼輸入相同 |

## 忘記密碼
![fig](忘密.jpg "忘記密碼")
| 欄位名稱 | 資料型態 | 驗證規則 |
|:-------:|:-------:|:-------:|
|電子信箱/手機 | string |檢查此帳號/手機是否註冊過|
...
| 欄位名稱 | 資料型態 | 驗證規則 |
|:-------:|:-------:|:-------:|
|使用者名稱 | string | 16個字元內的英數組合，且不得與其他使用者重複|
|手機 | int | 10個字元的整數，開頭須為09 |
|電子信箱 | string | 檢查電子信箱是否符合規定 |
